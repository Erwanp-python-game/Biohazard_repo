...
while running == 1:
    ...
    if len(wall_rend)>0:
        ...
        texture=wall_im_g[120*wall_index2+G_g[:,:,0],G_g[:,:,1]+120*((((-u[:,:,1]//120+phase_g[wall_index2])%freq_g[wall_index2]))==0)*(u[:,:,0]<120+1000*tile_z_g[wall_index2])]*light_g[wall_index2]
        milliseconds.append(time.perf_counter() * 1000)
